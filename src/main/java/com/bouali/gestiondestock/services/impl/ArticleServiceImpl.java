...
public class ArticleServiceImpl implements ArticleService {
    ...
    public void delete(Integer id) {
        ...
        if (!ligneCommandeClients.isEmpty()){
            throw new InvalidOperationException("Impossible de supprimer un article deja utiliser dans des commandes clients ",
                    ErrorCodes.ARTICLE_ALREADY_IN_USE) ;
        }
        List<LigneCommandeFournisseur> ligneCommandeFournisseurs = commandeFournisseurRepository.findAllByArticleId(id) ;
        if (!ligneCommandeFournisseurs.isEmpty()){
            throw new InvalidOperationException("Impossible de supprimer un article deja utiliser dans des commandes fournisseur ",
                    ErrorCodes.ARTICLE_ALREADY_IN_USE) ;
        }
